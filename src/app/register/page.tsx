  ...
  return (
    <div style={{ minHeight: "85vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "1.5rem" }}>
      <div className="glass-panel" style={{ maxWidth: "440px", width: "100%", padding: "2.5rem 2rem", borderRadius: "var(--radius-lg)" }}>
        <h1 style={{ fontSize: "1.6rem", fontWeight: "800", marginBottom: "0.5rem", textAlign: "center", color: "var(--primary)" }}>إنشاء حساب جديد ✨</h1>
        <p style={{ color: "var(--text-muted)", fontSize: "0.9rem", textAlign: "center", marginBottom: "2rem" }}>انضم لعائلة طبيعة واستمتع بتجربة تسوق صحية متكاملة</p>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          ...
          <div>
            <label style={{ display: "block", marginBottom: "0.5rem", fontWeight: "700", fontSize: "0.9rem" }}>🔑 كلمة المرور الآمنة</label>
            <input 
              type="password" 
              required 
              value={password} 
        ...
        <div style={{ marginTop: "1.5rem", textAlign: "center", color: "var(--text-muted)", fontSize: "0.9rem", fontWeight: "600" }}>
          لديك حساب بالفعل؟ <Link href="/login" style={{ color: "var(--primary)", fontWeight: "700" }}>تسجيل الدخول</Link>
        </div>
      </div>
    </div>
  );
